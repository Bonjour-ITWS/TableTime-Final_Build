...
<body>
	...
	<div class="container">
		...
		<!-- Table 1 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '1' AND Floor ='Folsom 3' ");
		...
		<!-- Table 2 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '2' AND Floor ='Folsom 3' ");
		...
		<!-- Table 3 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '3' AND Floor ='Folsom 3' ");
		...
		<!-- Table 4 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '4' AND Floor ='Folsom 3' ");
		...
		<!-- Table 5 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '5' AND Floor ='Folsom 3' ");
		...
		<!-- Table 6 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '6' AND Floor ='Folsom 3' ");
		...
		<!-- Table 7 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '7' AND Floor ='Folsom 3' ");
		...
		<!-- Table 8 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '8' AND Floor ='Folsom 3' ");
		...
		<!-- Table 9 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '9' AND Floor ='Folsom 3' ");
		...
		<!-- Table 10 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '10' AND Floor ='Folsom 3' ");
		...
		<!-- Table 11 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '11' AND Floor ='Folsom 3' ");
		...
		<!-- Table 12 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '12' AND Floor ='Folsom 3' ");
		...
		<!-- Table 13 -->
		<?php
		$check1 = mysqli_query($conn, "SELECT username FROM reservation WHERE Seat = '13' AND Floor ='Folsom 3' ");
